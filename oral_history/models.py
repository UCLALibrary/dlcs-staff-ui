...
class Projects(models.Model):
    ...
    image_submasters_dir = models.CharField(max_length=500, blank=True, null=True)
    audio_masters_dir = models.CharField(max_length=500, blank=True, null=True)
    audio_submasters_dir = models.CharField(max_length=500, blank=True, null=True)
    video_masters_dir = models.CharField(max_length=500, blank=True, null=True)
    video_submasters_dir = models.CharField(max_length=500, blank=True, null=True)
    text_masters_dir = models.CharField(max_length=500, blank=True, null=True)
    text_submasters_dir = models.CharField(max_length=500, blank=True, null=True)
    ...
    lob_submasters_dir = models.CharField(max_length=500, blank=True, null=True)
    ...
    website_masters_dir = models.CharField(max_length=500, blank=True, null=True)
